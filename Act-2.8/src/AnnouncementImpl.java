...
public class AnnouncementImpl implements Announcement {
	...
	public AnnouncementImpl(String title, String description, int category, double price, String picture, Date pubDate,
			String stat, boolean disponibility, int nbrViews, String localisation, int userId) {
		this.title = title;
		this.description = description;
		this.category = category;
		this.price = price;
	...
	public AnnouncementImpl(String title, String description, int category, double price, String picture, Date pubDate,
			boolean disponibility, int nbrViews, String localisation, int userId) {
		this.title = title;
		this.description = description;
		this.category = category;
		this.price = price;
